...
public class StudentCollectionUtils {
	...
	public static List<Student> populateList() {
		List<Student> students = new ArrayList<>(
				Arrays.asList(new Student("dac-001", "ravi", parse("1990-12-13"), ANGULAR, 7, List.of(35, 30)),
						new Student("dac-009", "riya", parse("1992-12-13"), REACT, 6.9, List.of(32, 28)),
						new Student("dac-004", "shekhar", parse("1991-12-13"), DBT, 8.9, List.of(35, 36)),
						new Student("dac-002", "priya", parse("1990-02-23"), JAVA, 7.7, List.of(30, 30)),
						new Student("dac-007", "kiran", parse("1993-02-13"), DBT, 8.1, List.of(35, 34)),
						new Student("dac-003", "meeta", parse("1993-12-13"), DBT, 7.9, List.of(28, 30)),
						new Student("dac-008", "sameer", parse("1991-12-06"), JAVA, 8.2, List.of(31, 30))));
	...
	// add a static method to accept list of student details & rets a map populated
	// with the same

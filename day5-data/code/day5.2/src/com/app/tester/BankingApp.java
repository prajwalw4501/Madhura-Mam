...
public class BankingApp {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			List<BankAccount> accounts = populateBankAccounts();// size : 0 , init capa :10
			while (!exit) {
				...
				try {
					...
					case 5: // funds transfer
						...
						System.out.println(BankingUtils.transferFunds(sc.nextInt(),sc.nextInt(),sc.nextDouble(),accounts));
						break;

...
To find out if customer exists or not  , what is required , before you can call contains ? 
Prog has to override -- equals method, inherited from Object class ,  to replace ref equality by content equality(Unique ID | PK)
+ supply overloaded ctor to wrap PK

Customer c=new  Customer(email);//a10@gmail.com
...
5.2 searching for last occurrence 
